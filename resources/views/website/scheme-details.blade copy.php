                    ...
                    <div class="scheme-info">
                        ...
                        <div class="wallet-tag">
                            ...
                            @else
                                ...
                                Every successful daily payment is credited to your jewellery wallet. You can make multiple
                        ...
                        <div class="feature-box">
                            ...
                            <div class="feature-content">
                                ...
                                @if($scheme->scheme_type == 'monthly')
                                    ...
                                    <h5>{{ $scheme->installments }} Monthly Installments</h5>

                                    <p>Flexible monthly savings plan.</p>

                                @else

                                    <h5>Minimum Daily Payment</h5>

                                    <p>₹{{ number_format($scheme->minimum_daily_amount, 2) }} per day. Multiple payments
                                        allowed.
                                    </p>
                    ...
                    <div class="card border-0 shadow-sm h-100" style="border-radius:18px;">
                        ...
                        <div class="card-body text-center p-4">
                            ...
                            <small class="text-muted d-block">
                                ...
                                {{ $scheme->scheme_type == 'monthly' ? 'Monthly Saving' : 'Minimum Daily Payment' }}
                        ...
                        <div class="row">
                            ...
                            @else
                                ...
                                <div class="col-md-6">
                                    ...
                                    <h5>
                                        Every successful payment is credited to your wallet.
                                    </h5>
                        ...
                        <div class="text-center mb-4">
                            ...
                            @if($scheme->scheme_type == 'daily')
                                ...
                                <small class="text-muted d-block mt-2">
                                    (Minimum Daily Amount + Joining Fee)
                                </small>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-muted">
                                Register and become a member of your preferred jewellery savings scheme.
                            </p>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        ...
                        <div class="p-4">
                            ...
                            @if($scheme->scheme_type == 'monthly')
                                ...
                                <p class="text-muted">
                                    Complete your monthly installment online or at the store.
                                </p>
                            ...
                            @else
                                ...
                                <p class="text-muted">
                                    Make one or more payments every day with the minimum daily amount.
                                </p>
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-muted">
                                ...
                                @if($scheme->scheme_type == 'monthly')
                                    ...
                                    Your monthly installment amount is credited to your jewellery wallet after every successful
                                    payment.
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-muted">
                                Redeem your wallet balance to purchase your favourite jewellery.
                            </p>
