...
<head>
    ...
    <meta name="description" content="veenasilks">
    <meta name="keywords" content="veenasilks">
    <meta name="author" content="veenasilks">
...
<style>
    ...
    .sidebar .sidebar-menu > ul > li.submenu-open .submenu-hdr, .settings-sidebar .sidebar-menu > ul > li.submenu-open .submenu-hdr{
        color: white !important;
    }
    .sidebar .sidebar-menu > ul > li.submenu-open ul li a, .settings-sidebar .sidebar-menu > ul > li.submenu-open ul li a {
        color: white !important;
    } */
</style>
