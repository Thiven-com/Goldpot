...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            @endif
            <form action="{{ route('admin.schemes.update', $scheme->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" value="{{ old('title', $scheme->title) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="scheme_code"
                                        value="{{ old('scheme_code', $scheme->scheme_code) }}" class="form-control">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ ucfirst($scheme->scheme_type) }}"
                                        readonly>

                                    <input type="hidden" name="scheme_type" value="{{ $scheme->scheme_type }}">
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" min="1" id="installments" name="installments"
                                            value="{{ old('installments', $scheme->installments) }}" class="form-control calc">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="bonus_type" id="bonus_type" class="form-select">
                                            ...
                                            <option value="fixed" {{ old('bonus_type', $scheme->bonus_type) == 'fixed' ? 'selected' : '' }}>
                                                Fixed
                                            </option>

                                            <option value="percentage" {{ old('bonus_type', $scheme->bonus_type) == 'percentage' ? 'selected' : '' }}>
                                                Percentage
                                            </option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" min="0" step="0.01" id="bonus_amount" name="bonus_amount"
                                            value="{{ old('bonus_amount', $scheme->bonus_amount) }}" class="form-control calc">
                            ...
                            @if($scheme->scheme_type == 'daily')
                                <div class="col-md-4" id="dailyAmountDiv">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" min="1" step="0.01" id="minimum_daily_amount"
                                            name="minimum_daily_amount"
                                            value="{{ old('minimum_daily_amount', $scheme->minimum_daily_amount) }}"
                                            class="form-control">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="0" step="0.01" name="joining_fee"
                                        value="{{ old('joining_fee', $scheme->joining_fee) }}" class="form-control">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($scheme->image)
                                    ...
                                    <img src="{{ asset($scheme->image) }}" id="preview" style="width:160px;border-radius:10px;">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="is_online" class="form-select">
                                        ...
                                        <option value="1" {{ old('is_online', $scheme->is_online) == 1 ? 'selected' : '' }}>
                                            Yes
                                        </option>

                                        <option value="0" {{ old('is_online', $scheme->is_online) == 0 ? 'selected' : '' }}>
                                            No
                                        </option>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-select">
                                        ...
                                        <option value="active" {{ old('status', $scheme->status) == 'active' ? 'selected' : ''
                                                                    }}>
                                            Active
                                        </option>

                                        <option value="inactive" {{ old('status', $scheme->status) == 'inactive' ? 'selected' :
        '' }}>
                                            Inactive
                                        </option>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="summernote" name="description" rows="6"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="summernote2" name="terms_conditions" rows="6"
